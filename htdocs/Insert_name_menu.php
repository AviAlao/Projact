<?php
	...
	//Input posted data.
	$NameMealMenu = $_POST["NameMeal"];
	$PriceMealMenu = $_POST["PriceMeal"];
	$MktMealMenu = $_POST["MktMeal"];
	$DescriptionMealMenu = $_POST["DescriptionMeal"];
	 
	//SQL query - user Details   
	$query = "INSERT INTO a_a_menu (Name_menu, Price, Mkt, Component)
	          VALUES ('$NameMealMenu', '$PriceMealMenu', '$MktMealMenu', '$DescriptionMealMenu')";
